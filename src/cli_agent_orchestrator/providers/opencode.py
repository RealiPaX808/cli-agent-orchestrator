...
RESPONSE_PATTERN = (
    r"⏺(?:\x1b\[[0-9;]*m)*\s+"  # Handle any ANSI codes between marker and text
)
...
class OpenCodeProvider(BaseProvider):
    ...
    def __init__(
        ...
        self._terminal_client = tmux_client

    def _build_opencode_command(self) -> List[str]:
    ...
    def extract_last_message_from_script(self, script_output: str) -> str:
        ...
        # Extract everything after last ⏺ until next prompt or separator
