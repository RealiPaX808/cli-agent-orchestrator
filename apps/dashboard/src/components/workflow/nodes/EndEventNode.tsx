...
interface EndEventData extends Record<string, unknown> {
  label?: string;
...
const EndEventNode = ({ data, selected }: NodeProps) => {
  const nodeData = data as EndEventData;
  ...
  return (
    <div style={{ position: 'relative' }}>
      <div style={{
        ...
        borderRadius: '10px',
        boxShadow: selected ? '0 0 0 3px rgba(239, 68, 68, 0.2)' : '0 2px 8px rgba(0, 0, 0, 0.3)',
